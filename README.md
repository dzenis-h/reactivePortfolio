...
<h3 align="center">📍 GitHub it with reactivePortfolio: Your career, Reactively Powered!</h3>
...
│   ├── manifest.json
│   ├── modernizr-custom.js
│   ├── precache-manifest.f9751c1cb65a903e5e35c0e57177d4d9.js
│   ├── robots.txt
│   ├── service-worker.js
└── src
    ├── App.js
    ...
    │   │   ├── Highlighted
    │   │   │   ├── HighlightedApp.js
    │   │   │   ├── HighlightedDescription.js
    │   │   │   ├── HighlightedHeader.js
    │   │   │   └── HighlightedList.js
    │   │   ├── WorkComponent.js
    │   │   └── WrokTemplate.js
    │   ├── contactForm
...
#### The last command runs the app in the development mode.<br>
Open [http://localhost:3000](http://localhost:3000) to view it in the browser.

### 🤖 Using reactivePortfolio
